...
public interface FireCompanyMapper {
     ...
     * 根据编码查询公司
     */
    FireCompany selectFireCompanyByCode(String companyCode);
     ...
     * 检查公司编码是否唯一
     */
    FireCompany checkCompanyCodeUnique(String companyCode);

    /**
     * 检查公司名称是否唯一
     */
    FireCompany checkCompanyNameUnique(String companyName);
     ...
     * 批量新增用户公司关联
     */
    int batchInsertUserCompany(List<FireUserCompany> list);

    /**
     * 删除用户公司关联
     */
    int deleteUserCompanyByCompanyId(Long companyId);

    /**
     * 删除指定用户的公司关联
     */
    int deleteUserCompanyByUserId(Long userId);

    /**
     * 删除指定用户和公司的关联
     */
    int deleteUserCompany(FireUserCompany userCompany);
