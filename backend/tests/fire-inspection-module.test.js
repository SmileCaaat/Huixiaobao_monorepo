...
assert.ok(pickerJs.includes('请选择一项') || pickerJs.includes('\u8bf7\u9009\u62e9\u4e00\u9879'), 'picker chinese title');
assert.ok(pickerJs.includes('选择日期') || pickerJs.includes('\u9009\u62e9\u65e5\u671f'), 'picker chinese date title');
